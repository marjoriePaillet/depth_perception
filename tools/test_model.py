...
nnPathDefault = str((Path(__file__).parent / Path('/home/reachy/depthai/resources/nn/custom_mobilenet/custom_mobilenet.blob')).resolve().absolute())
...
labelMap = ["background", "apple", "banana", "orange"]
